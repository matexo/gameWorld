...
/**
 * Performance test for the MarketOffer entity.
 */
class MarketOfferGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the MarketOffer entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all marketOffers")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created marketOffer")
                .get("${new_marketOffer_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created marketOffer")
            .delete("${new_marketOffer_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
